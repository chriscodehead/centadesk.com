...
$united_states_dollar = $row['united_states_dollar'];
$ghanaian_cedi = $row['ghanaian_cedi'];
$kenyan_shilling = $row['kenyan_shilling'];
$south_african_rand = $row['south_african_rand'];
$euro = $row['euro'];
$british_pound_sterling = $row['british_pound_sterling'];
$rwandan_franc = $row['rwandan_franc'];
$tanzanian_shilling = $row['tanzanian_shilling'];
$ugandan_shilling = $row['ugandan_shilling'];
$zambian_kwacha = $row['zambian_kwacha'];
$moroccan_dirham = $row['moroccan_dirham'];
$egyptian_pound = $row['egyptian_pound'];
