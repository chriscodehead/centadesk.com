...
$title = 'Application Form | Product Design (UI/UX) Masterclass - By Centadesk';
    ...
    if (filter_var($email, FILTER_VALIDATE_EMAIL)) {
      ...
      if ($cal->checkifdataExists($email, 'email', $user_tb) == 1) {
        ...
        if ($result == 'Registration was successful. Proceed to login!') {
            ...
            $message = '<h3 class="text-success">Congratulations ' . $fullname . '!</h3>
              ...
              <div class="col-md-8 col-lg-8">
                <div class="banner_title_inner">
                  <h1 class="c-white" data-aos="fade-up" data-aos-delay="0">
                    Product Design Application Form
                  </h1>
                  <p data-aos="fade-up" data-aos-delay="100">
                    Fill the form below with your correct details. Thanks
                  </p>
                  <center>
                    <!--<h1>
              ...
              <div class="col-lg-6">
                ...
                <div class="bbox__form" data-aos="fade-up" data-aos-delay="300">
                  <form action="" class="row" method="post" enctype="multipart/form-data">
                    ...
                    <label>Tell us more about your interest and expectations*</label>
