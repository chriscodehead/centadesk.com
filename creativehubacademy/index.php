            ...
            <div class="row">
              <div class="col-lg-8 mb-5">
                <div class="banner_title">
                  ...
                  <h1 style="padding-buttom:5px; margin-buttom:5px;" class="c-white">
                    Master Digital Product Design: UX Research & UI Design <span class="text-success">Cohort 3.0</span> <span style="font-size: 35px;">(Live Sessions)</span>
                  </h1>
                  
                  <div class="col-12"><iframe width="100%" height="315" src="https://www.youtube.com/embed/1U41a3uZD_E" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                
                <center><a href="https://chat.whatsapp.com/DAEm3bTfNV17TGcmRlckIW">
                    <button type="button" class="btn btn-primary mb-3 mt-3 btn-large" style="font-size: 24px;">Join Free Webiner</button></a></center>
                </div>
                  ...
                  <div class="prices">
                    ...
                    <p><?php print $currency_sign;?><?php print number_format($initial_pay); ?> /* <strike><?php print $currency_sign;?><?php print number_format($oldprice); ?></strike> </p>
                  </div>
                </div>
                <a href="apply" class="btn btn_md_primary bg-red effect-letter rounded-8 c-white mb-3 mb-sm-0 mr-2">
                  Apply Now!</a>
                <!--<button type="button" class="btn btn_watch btn_md_primary btn_video" data-toggle="modal" data-src="" data-target="#mdllVideo">
                  <i class="fa fa-trophy"></i>
                  Certified Course | Watch Video
                </button>
                
                <a href="https://chat.whatsapp.com/DAEm3bTfNV17TGcmRlckIW"><button type="button" class="btn btn-primary">
                  Join Free Webiner
                </button></a>
                -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 col-lg-12">
                      <div class="item__price popular">
                        ...
                        <div class="number">
                          <span class="n_price"><?php print $currency_sign;?><?php print number_format($initial_pay); ?></span>
                          <span class="duration"> /* <strike><?php print $currency_sign;?><?php print number_format($oldprice); ?></strike> </span>
                        </div>
                        <!-- icon Semicircle -->
                        <svg width="22" height="19" viewBox="0 0 22 19">
                          <g id="icon_semicircle" transform="translate(-325.349 -2843.002)">
          ...
          <div class="container">
            <div class="row justify-content-between">
              ...
              <div class="col-lg-5 mb-4 mb-lg-0" style="margin-top: 30px;">
                <div class="item_mmon">
                  <div class="profile_user">
                    <img src="img/christian-chika-codehead-Web-Developer-Centadesk.png" />
                    <div class="categ">
                      <span>Founder</span>
                    </div>
                  </div>
              ...
              <div class="col-lg-5" style="margin-top: 30px;">
                <div class="item_mmon">
                  <div class="profile_user">
                    <img src="img/Ani-Frankpeter-Product-Designer.png" />
                    <div class="categ">
                      <span>Mentor</span>
                    </div>
                  </div>
